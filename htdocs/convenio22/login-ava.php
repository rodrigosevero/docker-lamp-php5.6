...
if($total>0)
{
    // Obtém os dados do usuário, para poder verificar a senha e passar os demais dados para a sessão
		...
		header('Location: http://setec.ufmt.br/tce/cursosead/logar.php?username='.base64_encode($_SESSION['cpf']).'&firstname='.base64_encode($firstname).'&lastname='.base64_encode($lastname).'&email='.base64_encode($_SESSION['email']).'');
		...
		header('Location: https://setec.ufmt.br/tce/cursosead/logar.php?username='.base64_encode($_SESSION['cpf']).'&firstname='.base64_encode($firstname).'&lastname='.base64_encode($lastname).'&email='.base64_encode($_SESSION['email']).'');
    ...
    window.location.href='http://setec.ufmt.br/tce/cursosead/';
    </SCRIPT>");
