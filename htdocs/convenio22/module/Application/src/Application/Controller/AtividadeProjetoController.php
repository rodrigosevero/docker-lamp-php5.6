...
{	    	    
	...
	public function consultaAction()
	{
		...
		//try {
            ...
            $atividades_projeto1 = $this->getAtividadeProjetoTable()->getAtividadesAtivasByProjeto($projeto_id);
            $atividades_projeto_metas = array();
            foreach ($atividades_projeto1 as $v_atividades_projeto1){
                $atividades_projeto_bd = $this->getAtividadeProjetoTable()->getMetaAtividadesAtivasByProjeto($v_atividades_projeto1['id']);

                foreach ($atividades_projeto_bd as $dados)
                {
                    $metas[$v_atividades_projeto1['id']][] = $dados;
                }



                //foreach ($atividades_projeto_bd as $v_atividades_projeto_bd) {
                 //   $metas[$v_atividades_projeto_bd['id']] = array('descricao' => $v_atividades_projeto_bd['area1'], 'meta' => $v_atividades_projeto_bd['atividade']);
                //}
            }
//
//            echo '<pre>';
...
//		}
	...
	public function exportarAction()
	{
    	...
    	/* INICIO Grava log */
    	$log_acao = "atividade-projeto/exportar";
    	$log_acao_id = $projeto_id;
    	$log_acao_exibicao = 'Exportar atividades de projeto';
    	$this->salvarLog($log_acao, $log_acao_id, $log_acao_exibicao);
    	/* FIM Grava log */
